...
public class ModContainerTypes {
    ...
    public static ContainerType<SoundRecorderContainer> SOUND_RECORDER;

    @ObjectHolder("sound_dampener")
    public static ContainerType<SoundDampenerContainer> SOUND_DAMPENER;

    @ObjectHolder("portable_sound_dampener")
    public static ContainerType<PortableSoundDampenerContainer> PORTABLE_SOUND_DAMPENER;

    @ObjectHolder("imbuing_station")
    public static ContainerType<ImbuingStationContainer> IMBUING_STATION;

    @ObjectHolder("ender_letter")
    public static ContainerType<EnderLetterContainer> ENDER_LETTER;
    ...
    public static void registerContainerTypes(Register<ContainerType<?>> containerTypeRegistryEvent) {
        ...
        registry.register(IForgeContainerType.create(SoundRecorderContainer::new).setRegistryName("sound_recorder"));
        registry.register(IForgeContainerType.create(SoundDampenerContainer::new).setRegistryName("sound_dampener"));
        registry.register(IForgeContainerType.create(PortableSoundDampenerContainer::new).setRegistryName("portable_sound_dampener"));
